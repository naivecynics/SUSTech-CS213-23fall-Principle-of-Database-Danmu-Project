...
public class BenchmarkService {
    ...
    private static void debug(String str) {
        log.debug(str);
//        if (str.startsWith("Wrong answer")) {
//            System.exit(1);
//        }
    }
...
//        }
    ...
    public BenchmarkResult importData() {
        ...
        try {
            ...
            error("Exception encountered during importing data, you may early stop this run", e);
        }
...
//                } else {
//                    debug("Wrong answer for {}: expected {}, got {}", it.getKey(), it.getValue(), res);
//                }
//            } catch (Exception e) {
//                error("Exception thrown for {}", it, e);
//            }
//        });
//        val endTime = System.currentTimeMillis();
//
...
//                    pass.incrementAndGet();
//                } else {
//                    debug("Wrong answer for {}: expected size {}, got {}", it.getKey(), it.getValue(), resSize);
//                }
//            } catch (Exception e) {
//                error("Exception thrown for {}", it, e);
//            }
...
//                        pass.incrementAndGet();
//                    } else {
//                        debug("Wrong answer for {}: expected >= 0, got {}", it.getKey(), res);
//                    }
//                } else {
//                    if (res < 0) {
//                    } else {
    ...
    public BenchmarkResult getUserInfo() {
        ...
        cases.entrySet().parallelStream().forEach(it -> {
            try {
                ...
                error("Exception thrown for {}", it.getKey(), e);
            }
        });
        val endTime = System.currentTimeMillis();
...
//                    pass.incrementAndGet();
//                } else {
//                    debug("Wrong answer for {}: expected {}, got {}", it.getKey(), watched, res);
//                }
//            } catch (Exception e) {
//                error("Exception thrown for {}", it.getKey(), e);
//            }
...
//                        pass.incrementAndGet();
//                    } else {
//                        debug("Wrong answer for {}: expected not null, got null", it.getKey());
//                    }
//                } else {
//                    if (Objects.isNull(res)) {
//                        pass.incrementAndGet();
//                    } else {
//                        debug("Wrong answer for {}: expected null, got {}", it.getKey(), res);
//                    }
//                }
//            } catch (Exception e) {
//                error("Exception thrown for {}", it, e);
...
//                    pass.incrementAndGet();
//                } else {
//                    debug("Wrong answer for {}: expected true, got false", it);
//                }
//            } catch (Exception e) {
//                error("Exception thrown for {}", it, e);
//            }
